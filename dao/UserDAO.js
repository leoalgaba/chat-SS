...
function UserDAO(db) {
  ...
  if (false == (this instanceof UserDAO)) {
    console.log('WARNING: Constructor UserDAO llamado sin operador "new"');
  ...
  this.addUser = function (username, password, email, callback) {
    ...
    users.findOne({'_id': username}, function (err, user) {
      ...
      if (user) {
        var user_yet_exist_error = new Error('El usuario ya existe');
        user_yet_exist_error.msg = "Usuario ya existente"
